package com.safi_d.sistemas.safdiscomert.Informes;
...
import com.safi_d.sistemas.safdiscomert.Auxiliar.SpinnerDialog;
...
import com.safi_d.sistemas.safdiscomert.Entidades.Bancos;
import com.safi_d.sistemas.safdiscomert.Entidades.Cliente;
import com.safi_d.sistemas.safdiscomert.Entidades.Informe;
import com.safi_d.sistemas.safdiscomert.Entidades.InformeDetalle;
...
public class AgregarRecibo extends Activity {
    ...
    private boolean GuardarDetalleInforme() {
        ...
        for (HashMap<String, String> item : listaRecibos) {
            ...
            informedetalle.setUsuario("SAFDISCOMERT");
