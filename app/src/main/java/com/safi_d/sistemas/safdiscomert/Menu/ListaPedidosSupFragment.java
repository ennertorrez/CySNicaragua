...
import com.safi_d.sistemas.safdiscomert.Entidades.Supervisor;
...
public class ListaPedidosSupFragment extends Fragment {
    ...
    private void GetPedidosService() throws Exception {
        ...
        String urlString = urlPedidosVendedor + "/" + vendedor.getCODIGO() + "/" + Fdesde + "/" + Fhasta + "/0/" + variables_publicas.usuario.getEmpresa_ID();
